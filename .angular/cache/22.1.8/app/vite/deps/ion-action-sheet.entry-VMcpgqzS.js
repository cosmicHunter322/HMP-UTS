import { _ as readTask, c as createEvent, d as getElement, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
import "./index-DmnOg_xm-CoMu4g4x.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-action-sheet.entry.js
/*!
...
var ActionSheet = class {
	...
	buttonsChanged() {
		...
		if (this.hasRadioButtons) {
			...
			if (checkedButton) {
				const checkedIndex = this.getButtons().indexOf(checkedButton);
	...
	*/
	...
	async buttonClick(button) {
		...
		if (isCancel(role)) return this.dismiss(button.data, role);
		if (await this.callButtonHandler(button)) return this.dismiss(button.data, button.role);
	...
	*/
	onKeydown(ev) {
		...
		if (!this.el.contains(target) || !target.classList.contains("action-sheet-button") || target.getAttribute("role") !== "radio") return;
	...
	*/
	setupButtonActiveGesture() {
		...
		if (getIonMode(this) !== "ios" || !wrapperEl || !groupEl) return;
		readTask(() => {
			if (this.gesture || !this.el.isConnected || groupEl.scrollHeight > groupEl.clientHeight) return;
	...
	renderActionSheetButtons(filteredButtons) {
		...
		return filteredButtons.map((b, index) => {
			...
			*/
			let tabIndex;
			if (isRadio) if (isActiveRadio) tabIndex = 0;
			else if (!activeRadioId && isFirstRadio) tabIndex = 0;
			else tabIndex = -1;
			else tabIndex = void 0;
			const htmlAttrs = { ...b.htmlAttributes };
			if (isRadio) htmlAttrs["aria-checked"] = isActiveRadio ? "true" : "false";
			/**
			...
			*/
			...
			return h("button", {
				...
				onClick: () => {
					if (isRadio) this.selectRadioButton(b);
					this.buttonClick(b);
				},
				disabled: b.disabled,
				tabIndex
			}, h("span", { class: "action-sheet-button-inner" }, b.icon && h("ion-icon", {
				icon: b.icon,
				"aria-hidden": "true",
				lazy: false,
				class: "action-sheet-icon"
			}), renderOptionLabel(optionLabelOptions, "action-sheet-button-label", true)), mode === "md" && h("ion-ripple-effect", null));
		});
	}
	render() {
		...
		return h(Host, {
			key: "83b47ea6b81d4eec6582c1dcaae6f267c78ba634",
			role: "dialog",
			"aria-modal": "true",
			...
			key: "3652793ec76adcfb87b814eb65d1260ae26f6910",
			tappable: this.backdropDismiss
		}), h("div", {
			key: "7de3a51daf95b50e02734a2cc8eec6f55b1473f3",
			tabindex: "0",
			"aria-hidden": "true"
		}), h("div", {
			key: "9b76bbf12901b956f7ee6d984f7f71e169bb5939",
			class: "action-sheet-wrapper ion-overlay-wrapper",
			ref: (el) => this.wrapperEl = el
		}, h("div", {
			key: "cb52c905275a46ff27810fb1b4748ab533a78c45",
			class: "action-sheet-container"
		}, h("div", {
			key: "578c7194cfbcb65c1e41e15c390af41f179a2686",
			class: "action-sheet-group",
			ref: (el) => this.groupEl = el,
			role: hasRadioButtons ? "radiogroup" : void 0
		}, header !== void 0 && h("div", {
			key: "ee961307c25cb1fcb0c6bbf667a8ed76ab717860",
			id: headerID,
			class: {
			...
			key: "82d4016010db14d3f3b9911c276cb9a63b960ef4",
			class: "action-sheet-sub-title"
		}, this.subHeader)), this.renderActionSheetButtons(buttons)), cancelButton && h("div", {
			key: "a88fbfab194e13c6642a65f2e19a12299dd4ac23",
			class: "action-sheet-group action-sheet-group-cancel"
		}, h("button", {
			key: "a232b8d23f1fc2efb7b37a605102b6994761a2f6",
			...cancelButton.htmlAttributes,
			type: "button",
			class: buttonClass(cancelButton),
			onClick: () => this.buttonClick(cancelButton)
		}, h("span", {
			key: "19a7d95d3428d78a56b7dacabdec8fc0b722d8c2",
			class: "action-sheet-button-inner"
		}, cancelButton.icon && h("ion-icon", {
			key: "5f3f3cb996a48e6365a3a09ea72ddc68ac9ccb78",
			icon: cancelButton.icon,
			"aria-hidden": "true",
			lazy: false,
			class: "action-sheet-icon"
		}), cancelButton.text), mode === "md" && h("ion-ripple-effect", { key: "6e8fcb5f103ac19aa4b0682f19791cef0a147001" }))))), h("div", {
			key: "36f63ab77949c88f662e2cf6bb18510cb9de6a9f",
			tabindex: "0",
			"aria-hidden": "true"
		}));
	}
