import { a as config, d as getElement, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
import { s as chevronBack, t as arrowBackSharp } from "./index-BvabGprD-DxcnQO2v.js";
//#region node_modules/@ionic/core/dist/esm/ion-back-button.entry.js
/*!
...
var BackButton = class {
	constructor(hostRef) {
		...
		*/
		...
		this.onClick = async (ev) => {
			...
			ev.preventDefault();
			if (nav && await nav.canGoBack()) return nav.pop({
	...
	componentWillLoad() {
		...
		if (this.defaultHref === void 0) this.defaultHref = config.get("backButtonDefaultHref");
	}
	get backButtonIcon() {
		const icon = this.icon;
		if (icon != null) return icon;
		if (getIonMode(this) === "ios") return config.get("backButtonIcon", chevronBack);
	...
	get rippleType() {
		if (this.hasIconOnly) return "unbounded";
		return "bounded";
	}
	render() {
