import { c as createEvent, d as getElement, h as printIonWarning, l as forceUpdate, p as h, r as Host, u as getAssetPath, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
import { d as hasShadowDom, f as inheritAriaAttributes } from "./helpers-BJFnZngp-COG28xNj.js";
import { t as getIonMode$1 } from "./ionic-global-BSaFA7np-C0AYHzhu.js";
import { i as openURL, r as hostContext, t as createColorClasses$1 } from "./theme-byZM6qHV-CVcL0HyM.js";
//#region node_modules/@ionic/core/dist/esm/ion-button_2.entry.js
/*!
...
var Button = class {
	constructor(hostRef) {
		...
		*/
		...
		this.handleClick = (ev) => {
			const { el } = this;
			if (this.type === "button") openURL(this.href, ev, this.routerDirection, this.routerAnimation);
			else if (hasShadowDom(el)) this.submitForm(ev);
		};
		this.onFocus = () => {
			this.ionFocus.emit();
		};
	...
	disabledChanged() {
		const { disabled } = this;
		if (this.formButtonEl) this.formButtonEl.disabled = disabled;
	}
	/**
	...
	*/
	...
	get rippleType() {
		if ((this.fill === void 0 || this.fill === "clear") && this.hasIconOnly && this.inToolbar) return "unbounded";
		return "bounded";
	}
	/**
	...
	*/
	findForm() {
		...
		if (typeof form === "string") {
			...
			if (el) if (el instanceof HTMLFormElement) return el;
			else {
				/**
	...
	render() {
		...
		let fill = this.fill;
		if (fill === void 0) fill = this.inToolbar || this.inListHeader ? "clear" : "solid";
		...
		return h(Host, {
			...
			name: "start"
		}), h("slot", { key: "0d7b0966e328a5b10b0562dacbd638dfd08d92af" }), h("slot", {
	...
	*/
	...
	render() {
		...
		*/
		...
		}) : h("div", { class: "icon-inner" }, h("slot", null)));
	}
