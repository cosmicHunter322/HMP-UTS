...
//#region node_modules/@ionic/core/dist/esm/ion-checkbox.entry.js
/*!
...
var Checkbox = class {
	constructor(hostRef) {
		...
		*/
		...
		this.onKeyDown = (ev) => {
			if (ev.key === " ") {
				ev.preventDefault();
				if (!this.disabled) this.toggleChecked(ev);
			}
		};
		this.onClick = (ev) => {
	...
	connectedCallback() {
		...
		if (typeof MutationObserver !== "undefined") {
			this.validationObserver = new MutationObserver((mutations) => {
				if (mutations.some((mutation) => mutation.type === "characterData" || mutation.type === "childList")) this.hasLabelContent = this.el.textContent !== "";
	...
	*/
	renderHintText() {
		...
		return h("div", { class: "checkbox-bottom" }, h("div", {
			id: helperTextId,
			class: "helper-text",
	...
	render() {
		...
		}, h("slot", { key: "3c444ab897456c522588fc6cee616030f16b0586" }), this.renderHintText()), h("div", {
	...
	getSVGPath(mode, indeterminate) {
		...
		if (mode === "md") path = indeterminate ? h("path", {
			d: "M2 12H22",
			part: "mark"
		}) : h("path", {
