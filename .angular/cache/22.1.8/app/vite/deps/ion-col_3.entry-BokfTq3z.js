import { l as forceUpdate, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
import { t as getIonMode } from "./ionic-global-BSaFA7np-C0AYHzhu.js";
//#region node_modules/@ionic/core/dist/esm/ion-col_3.entry.js
/*!
...
var matchBreakpoint = (breakpoint) => {
	if (breakpoint === void 0 || breakpoint === "") return true;
...
var Col = class {
	...
	getColumns(property) {
		...
		for (const breakpoint of BREAKPOINTS) {
			...
			if (matches && columns !== void 0) matched = columns;
		}
		return matched;
	}
	calculateSize() {
	...
	render() {
		...
		return h(Host, {
			key: "e12293a4315cb474bbde73421dd0b4129f1df1cc",
			class: { [getIonMode(this)]: true },
			style: {
...
var Row = class {
	...
	render() {
		return h(Host, {
			key: "12b7419dd67ff18dd00e1bf5093299bd94c75503",
			class: getIonMode(this)
		}, h("slot", { key: "43fc76a289ecaf398a77a90034ee576003a826fd" }));
	}
};
Row.style = rowCss();
//#endregion
