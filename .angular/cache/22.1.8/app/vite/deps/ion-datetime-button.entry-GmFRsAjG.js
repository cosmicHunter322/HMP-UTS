import { d as getElement, m as printIonError, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
import { i as componentOnReady, t as addEventListener } from "./helpers-BJFnZngp-COG28xNj.js";
...
import { R as parseDate, f as getHourCycle, g as getLocalizedTime, m as getLocalizedDateTime } from "./format-D78cdY12-CN8_pjdm.js";
//#region node_modules/@ionic/core/dist/esm/ion-datetime-button.entry.js
/*!
...
var DatetimeButton = class {
	constructor(hostRef) {
		...
		this.setDateTimeText = async () => {
			...
			*/
			...
			switch (datetimePresentation) {
				case "date-time":
				case "time-date":
					const dateText = getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? {
						month: "short",
						day: "numeric",
						year: "numeric"
					});
					const timeText = getLocalizedTime(locale, firstParsedDatetime, computedHourCycle, formatOptions?.time);
					if (preferWheel) this.dateText = `${dateText} ${timeText}`;
					else {
				...
				case "date":
					...
					} else this.dateText = getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? {
						month: "short",
						day: "numeric",
						year: "numeric"
					});
				...
				case "time":
					...
					break;
				case "month-year":
					this.dateText = getLocalizedDateTime(locale, firstParsedDatetime, formatOptions?.date ?? {
						month: "long",
						year: "numeric"
					});
					break;
		...
		*/
		this.waitForDatetimeChanges = async () => {
			...
			if (!datetimeEl) return Promise.resolve();
		...
		this.handleTimeClick = (ev) => {
			...
			*/
			switch (datetimePresentation) {
				case "date-time":
				case "time-date":
					if (datetimeEl.presentation !== "time") {
		...
		*/
		this.presentOverlay = async (ev, needsPresentationChange, triggerEl) => {
			...
			if (overlayEl.tagName === "ION-POPOVER") {
				...
				*/
				if (needsPresentationChange) await this.waitForDatetimeChanges();
				/**
				...
				*/
				overlayEl.present({
					...ev,
					detail: { ionShadowTarget: triggerEl }
				});
			} else overlayEl.present();
		};
	}
	async componentWillLoad() {
		...
		*/
		...
		}, { threshold: .01 }).observe(datetimeEl);
		/**
		...
		*/
		if (overlayEl) overlayEl.classList.add("ion-datetime-button-overlay");
	...
	render() {
		...
		return h(Host, {
			key: "2aaa284fe9b53b6347fcb5a1d325fbab1a6f38bd",
			...
			key: "d9698471fa5d5c834ca73db57f9ed98dfc705b4c",
			...
			key: "c8761a7f25ae5b93c953b3486dd6335f5ad4fd53",
			name: "date-target"
		}, dateText), mode === "md" && h("ion-ripple-effect", { key: "3dd5e97af8d35a2b008de4ab01f690b3c2223135" })), timeText && h("button", {
			key: "1107ca2382940b642b551f885f7ca763012c236c",
			class: "ion-activatable",
			id: "time-button",
			"aria-expanded": datetimeActive ? "true" : "false",
			...
			key: "5cff53e486923b03715b9ab4dc0947e26f4ea1d9",
			name: "time-target"
		}, timeText), mode === "md" && h("ion-ripple-effect", { key: "5aac1facb6fc7457307c4f59a241e3a5b31facc8" })));
	}
	get el() {
