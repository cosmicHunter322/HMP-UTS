...
import { f as close } from "./index-BvabGprD-DxcnQO2v.js";
//#region node_modules/@ionic/core/dist/esm/ion-fab_3.entry.js
/*!
...
var Fab = class {
	...
	activatedChanged() {
		...
		if (fab) fab.activated = activated;
		Array.from(this.el.querySelectorAll("ion-fab-list")).forEach((list) => {
			list.activated = activated;
		});
	}
	componentDidLoad() {
		if (this.activated) this.activatedChanged();
	}
	/**
	...
	*/
	async toggle() {
		if (!!this.el.querySelector("ion-fab-list")) this.activated = !this.activated;
	}
	render() {
...
var FabButton = class {
	constructor(hostRef) {
		...
		*/
		...
		this.onClick = (ev) => {
			const { el, fab } = this;
			if (this.type !== "button" && hasShadowDom(el)) this.submitForm(ev);
			if (fab) fab.toggle();
		};
	}
	disabledChanged() {
	...
	*/
	...
	render() {
		...
		*/
		if (type !== "button") this.renderHiddenButton();
		return h(Host, {
			...
			onBlur: this.onBlur,
			onClick: (ev) => type === "button" && openURL(href, ev, this.routerDirection, this.routerAnimation),
			...inheritedAttributes
		}, h("ion-icon", {
			...
			class: "button-inner"
		}, h("slot", { key: "f44fc1e95533438ee3adc8cc5bdd9e1e85849fd6" })), mode === "md" && h("ion-ripple-effect", { key: "b7c7dc7fceb0bb5613239608225f040010b7b2bd" })));
	}
	get el() {
		return getElement(this);
	}
