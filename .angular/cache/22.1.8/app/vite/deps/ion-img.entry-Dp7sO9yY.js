...
//#region node_modules/@ionic/core/dist/esm/ion-img.entry.js
/*!
...
var Img = class {
	...
	addIO() {
		...
		} else this.loadTimeout = setTimeout(() => this.load(), 200);
	}
	load() {
	...
	render() {
		...
		return h(Host, {
			key: "57bfb44d9850381fe7b6fcf0c9019b03f7ef86ec",
			class: getIonMode(this)
		}, h("img", {
			key: "888ec06a266fa2751fc0147ede6a567f4e2b29a6",
			decoding: "async",
			src: loadSrc,
			alt,
			onLoad,
