import { c as createEvent, d as getElement, l as forceUpdate, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
import { f as inheritAriaAttributes, i as componentOnReady, o as debounceEvent, p as inheritAttributes } from "./helpers-BJFnZngp-COG28xNj.js";
...
import { i as createStartContainerController, n as createNotchController, r as createSlotMutationController, t as createClickController } from "./slot-mutation-controller-D7n8Peo2-BISKMHTP.js";
import { t as getCounterText } from "./input.utils-C3mVJhji-BdEM1-a9.js";
//#region node_modules/@ionic/core/dist/esm/ion-input.entry.js
/*!
 ...
 /**
		...
		*/
		this.onLabelClick = (ev) => {
			...
			if (slotted === null || slotted === this.el || !this.el.contains(slotted)) ev.stopPropagation();
		};
	}
	debounceChanged() {
	...
	*/
	onTypeChange() {
		...
		if (passwordToggle) passwordToggle.type = this.type;
	}
	/**
 ...
 /**
	...
	*/
	...
	checkClearOnEdit(ev) {
		...
		* be cleared.
		*/
		if (!pressedIgnoredKey) this.didInputClearOnEdit = true;
	}
	hasValue() {
	...
	*/
	...
	renderCounter() {
		...
		if (counter !== true || maxlength === void 0) return;
	...
	*/
	renderBottomContent() {
		...
		if (!(!!helperText || !!errorText) && !(counter === true && maxlength !== void 0)) return;
	...
	renderLabel() {
		...
		}, label === void 0 ? h("slot", { name: "label" }) : h("div", {
			class: "label-text",
			id: labelTextId
		}, label));
	}
	...
	*/
	setSlottedLabelId() {
		...
		if (slottedLabel && !slottedLabel.id) slottedLabel.id = this.labelTextId;
	}
	/**
	...
	*/
	getLabelledById() {
		if (this.inheritedAttributes["aria-label"]) return;
		if (this.label !== void 0) return this.labelTextId;
	...
	*/
	renderOutlineContainer() {
		...
		}, this.label)), h("div", { class: "input-outline-end" }));
	}
	render() {
		...
		*/
		...
		return h(Host, {
			key: "290cf987de670276bf40b9f19d35d3769d9c0540",
			...
			key: "7827c61ffdd02952fc8cf2096f621b50fc51ec03",
			class: "input-start",
			ref: (el) => this.startContainerEl = el
		}, h("slot", {
			key: "1d8af52d3506742d87334b388859a8bf613e1be0",
			name: "start"
		})), h("div", {
			key: "927a412064538c00df98fabc06a32c564d05e984",
			class: "input-control"
		}, this.renderLabel(), h("div", {
			key: "05f80c0b11a7da57445f976bd2dbb557fa63c9bc",
			class: "native-wrapper",
			onClick: this.onLabelClick
		}, h("input", {
			key: "cb6f5d81ba7c2a04cc4c9deb5d3f5bca8562b6db",
			class: "native-input",
			...
			key: "82cd1b0458dcd491fd1a46b29764f2b79a969bc6",
			class: "input-end"
		}, this.clearInput && !readonly && !disabled && h("button", {
			key: "dfcf0ed81cf36fc61b8e12ed4605ac6b6eb50dad",
			"aria-label": "reset",
			type: "button",
			...
			key: "11e2c866135f332e81b4637de178e1c5c7da0d38",
			"aria-hidden": "true",
			icon: clearIconData
		})), h("slot", {
			key: "afb0e75e7103b2bf925a9c7649c93eb1d5702670",
			name: "end"
		})), shouldRenderHighlight && h("div", {
			key: "1f305bba279e93685d7139acf0aff6bf4a77500c",
