import { a as config, c as createEvent, d as getElement, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
import { S as restoreRootFocusTrapAccessibility, b as prepareOverlay, c as createTriggerController, l as dismiss, o as cleanupRootFocusTrapAccessibility, s as createDelegateController, t as BACKDROP, u as eventMethod, w as setOverlayId, x as present } from "./overlays-a_5AhqWk-BAKKNgyR.js";
import { t as createLockController } from "./lock-controller-B-hirT0v-wdq_Ov9y.js";
//#region node_modules/@ionic/core/dist/esm/ion-loading.entry.js
/*!
...
var Loading = class {
	...
	*/
	async present() {
		...
		if (this.duration > 0) this.durationTimeout = setTimeout(() => this.dismiss(), this.duration + 10);
		unlock();
	}
	/**
	...
	*/
	...
	render() {
		...
		return h(Host, {
			key: "b4430bc66aedeca19d5645667cba73c169c4bd76",
			role: "dialog",
			"aria-modal": "true",
			"aria-labelledby": message !== void 0 ? msgId : null,
			tabindex: "-1",
			...htmlAttributes,
			...
			key: "dec0df942ae778c99ebd4dbf08d6c2a0a992639d",
			visible: this.showBackdrop,
			tappable: this.backdropDismiss
		}), h("div", {
			key: "71b2d5fc259666225047fc901648ada1efcd5d4b",
			tabindex: "0",
			"aria-hidden": "true"
		}), h("div", {
			key: "1d83dc3b57ee70c9e8c0f006c6fa576bd96ecded",
			class: "loading-wrapper ion-overlay-wrapper"
		}, spinner && h("div", {
			key: "d1cd127e044b8831e396b53122322c1db7e89904",
			class: "loading-spinner"
		}, h("ion-spinner", {
			key: "38c2580cf5659da612872f01801a5fbdc2c023ba",
			name: spinner,
			"aria-hidden": "true"
		})), message !== void 0 && this.renderLoadingMessage(msgId)), h("div", {
			key: "90e5e32ffe0df2c691f364149f43374e676bfaa3",
			tabindex: "0",
			"aria-hidden": "true"
		}));
	}
