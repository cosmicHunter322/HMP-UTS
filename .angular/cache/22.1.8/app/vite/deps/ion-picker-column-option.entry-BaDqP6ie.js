import { d as getElement, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-picker-column-option.entry.js
/*!
...
var PickerColumnOption = class {
	...
	*/
	componentDidLoad() {
		...
		if (pickerColumn !== null) pickerColumn.scrollActiveItemIntoView();
	}
	/**
	...
	*/
	onClick() {
		const { pickerColumn } = this;
		if (pickerColumn !== null) pickerColumn.setValue(this.value);
	}
	render() {
		const { color, disabled, ariaLabel } = this;
		return h(Host, {
			key: "81f1938e0114392a6e035442b8bc9fcdf73fda84",
			class: createColorClasses(color, {
				[getIonMode(this)]: true,
				["option-disabled"]: disabled
			})
		}, h("div", {
			key: "b0bb84fd39ea38ea3037ad43c6be8e8dfca2e7d1",
			class: "picker-column-option-button",
			role: "button",
			"aria-label": ariaLabel,
			onClick: () => this.onClick()
		}, h("slot", { key: "e0305b721618aef05823032ccd58214b0f184ca9" })));
	}
	get el() {
