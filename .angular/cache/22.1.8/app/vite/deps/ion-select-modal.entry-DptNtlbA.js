import { d as getElement, l as forceUpdate, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
import { C as safeCall } from "./overlays-a_5AhqWk-BAKKNgyR.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-select-modal.entry.js
/*!
...
var SelectModal = class {
	...
	render() {
		return h(Host, {
			key: "791e95b985dd4b135db17a25fc678e9f8b73c597",
			class: getIonMode(this)
		}, h("ion-header", { key: "697d18eef394c4c11c73afe69b9eadd1bad97d38" }, h("ion-toolbar", { key: "036968824ad8771020fe2b7604a6e72b73efc8ae" }, this.header !== void 0 && h("ion-title", { key: "102e0346be83e879e733f9b410437b26216156aa" }, this.header), h("ion-buttons", {
			key: "436b997e990ce2f5e12e1651f8afc31ae231f7b0",
			slot: "end"
		}, h("ion-button", {
			key: "ee4ddfd0612d33583aa0b93ebdb5257b10d4fda5",
			onClick: () => this.closeModal()
		}, this.cancelText)))), h("ion-content", { key: "38ea098f85ac69226e614e0a09f668e9209f7ea1" }, h("ion-list", { key: "20becc2537a1a027915fe0598203039ceb8ba4f3" }, this.multiple === true ? this.renderCheckboxOptions() : this.renderRadioOptions())));
	}
	get el() {
