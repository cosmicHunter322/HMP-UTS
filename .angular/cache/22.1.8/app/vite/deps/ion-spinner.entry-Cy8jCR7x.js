import { a as config, p as h, r as Host, v as registerInstance } from "./index-Dvqtt_WK-CtfmC4By.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-spinner.entry.js
/*!
...
var Spinner = class {
	...
	getName() {
		...
		if (spinnerName) return spinnerName;
	...
	render() {
		...
		const svgs = [];
		if (spinner.circles !== void 0) for (let i = 0; i < spinner.circles; i++) svgs.push(buildCircle(spinner, duration, i, spinner.circles));
		else if (spinner.lines !== void 0) for (let i = 0; i < spinner.lines; i++) svgs.push(buildLine(spinner, duration, i, spinner.lines));
		return h(Host, {
			key: "87102ff9ea58b0ecde5d0978386374f7d0e9cf98",
