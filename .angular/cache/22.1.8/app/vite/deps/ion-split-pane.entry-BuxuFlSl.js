...
//#region node_modules/@ionic/core/dist/esm/ion-split-pane.entry.js
/*!
...
var SplitPane = class {
	...
	*/
	...
	async connectedCallback() {
		if (typeof customElements !== "undefined" && customElements != null) await customElements.whenDefined("ion-split-pane");
	...
	*/
	styleMainElement() {
		...
		if (!foundMain) printIonWarning("[ion-split-pane] - Does not have a specified main node.");
	}
	render() {
		const mode = getIonMode(this);
		return h(Host, {
			key: "652bc0965ae962dc36a67fd7129dacaa1ba8e551",
			class: {
				[mode]: true,
