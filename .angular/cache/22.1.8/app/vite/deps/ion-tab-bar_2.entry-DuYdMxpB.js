...
import { p as inheritAttributes } from "./helpers-BJFnZngp-COG28xNj.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-tab-bar_2.entry.js
/*!
...
var TabBar = class {
	...
	selectedTabChanged() {
		...
		if (this.selectedTab !== void 0) this.ionTabBarChanged.emit({ tab: this.selectedTab });
	}
	componentDidLoad() {
	...
	render() {
		...
		return h(Host, {
			key: "5c56cffd380df7720f3309af7cfca71500817678",
			role: "tablist",
...
var TabButton = class {
	constructor(hostRef) {
		...
		*/
		this.selected = false;
		this.onKeyUp = (ev) => {
			if (ev.key === "Enter" || ev.key === " ") this.selectTab(ev);
		};
		this.onClick = (ev) => {
			this.selectTab(ev);
		};
	...
	onTabBarChanged(ev) {
		...
		if (ev.composedPath().includes(parent) || dispatchedFrom?.contains(this.el)) this.selected = this.tab === ev.detail.tab;
	}
	componentWillLoad() {
		this.inheritedAttributes = { ...inheritAttributes(this.el, ["aria-label"]) };
		if (this.layout === void 0) this.layout = config.get("tabButtonLayout", "icon-top");
	}
	selectTab(ev) {
		if (this.tab !== void 0) {
			if (!this.disabled) this.ionTabButtonClick.emit({
				tab: this.tab,
				href: this.href,
	...
	render() {
		...
		return h(Host, {
			key: "45bb7ffa6d8764202adc2c5c393748d4003e86fe",
			...
			key: "78c416609a2b86a6e7c5f217ffd2a6b9f80a5103",
			...attrs,
			class: "button-native",
			part: "native",
			role: "tab",
			...
			key: "62934156439ffd0ab86674b9cf89d9cfa0d3589c",
			class: "button-inner"
		}, h("slot", { key: "293ba8f5ef50373c4e6e492dcaa55b3d2aae8d2f" })), mode === "md" && h("ion-ripple-effect", {
			key: "360b010afedcf17fc1f3ab6d192f0f8c7b1cf112",
			type: "unbounded"
		})));
	}
	get el() {
