import { c as createEvent, d as getElement, l as forceUpdate, p as h, r as Host, v as registerInstance, x as writeTask } from "./index-Dvqtt_WK-CtfmC4By.js";
...
//#region node_modules/@ionic/core/dist/esm/ion-textarea.entry.js
/*!
 ...
 /**
	...
	*/
	valueChanged() {
		...
		if (nativeInput && nativeInput.value !== value) nativeInput.value = value;
		this.runAutoGrow();
	}
	/**
	...
	*/
	...
	connectedCallback() {
		...
		document.dispatchEvent(new CustomEvent("ionInputDidLoad", { detail: el }));
	}
	...
	*/
	...
	runAutoGrow() {
		if (this.nativeInput && this.autoGrow) writeTask(() => {
			if (this.textareaWrapper) this.textareaWrapper.dataset.replicatedValue = this.value ?? "";
		});
	}
	/**
	...
	*/
	checkClearOnEdit(ev) {
		...
		* be cleared.
		*/
		if (!pressedIgnoredKey) this.didTextareaClearOnEdit = true;
	}
	hasValue() {
	...
	*/
	renderOutlineContainer() {
		...
		}, this.label)), h("div", { class: "textarea-outline-end" }));
	}
	/**
	...
	*/
	...
	render() {
		...
		*/
		...
		return h(Host, {
			key: "0f01ed6565313c45beaea5e0aa429a86b9cfa1a0",
			...
			key: "a59548c3d3bf66543fd6e06b5c3b6e649f963164",
			class: "textarea-wrapper",
			htmlFor: inputId,
			onClick: this.onLabelClick
		}, hasOutlineFill && this.renderOutlineContainer(), h("div", {
			key: "29055193d664d9fe84ba0340fdcbbc54fec0e403",
			class: "textarea-start",
			ref: (el) => this.startContainerEl = el
		}, h("slot", {
			key: "2cc122d9541ce7ae3c2309c27123b6c6c91cbfc7",
			name: "start"
		})), h("div", {
			key: "c847a6fa1eaf6ef2b296415cd72bdd3aee9828a2",
			class: "textarea-control"
		}, this.renderLabel(), h("div", {
			key: "f9205f82d6346daa86dc7e0f6e1eb221c76ed7b0",
			class: "native-wrapper",
			ref: (el) => this.textareaWrapper = el
		}, h("textarea", {
			key: "0bdb517fa5b3a44eeb3bb2ed1f9a8eab21a9a6a1",
			...
			key: "1ce661b800ef12146bdb97fb193e22be227ea052",
			class: "textarea-end"
		}, h("slot", {
			key: "aca5704db48fe8e0e784cf57f2978ae2d63b3edc",
			name: "end"
		})), shouldRenderHighlight && h("div", {
			key: "d916816d44cbdb4bc9a05032c5490eaa9bf3ba47",
