...
import { b as renderHiddenInput, f as inheritAriaAttributes } from "./helpers-BJFnZngp-COG28xNj.js";
...
import { h as ellipseOutline, o as checkmarkOutline, x as removeOutline } from "./index-BvabGprD-DxcnQO2v.js";
import { r as hapticSelection } from "./haptic-D3njgGLB-CR0w36Fl.js";
import { t as createItemMultipleInputsObserver } from "./item-multiple-inputs-CffmpUe9-DzsiBYo5.js";
import { t as checkInvalidState } from "./validity-DJztqcrH-if6nl8R-.js";
//#region node_modules/@ionic/core/dist/esm/ion-toggle.entry.js
/*!
...
var Toggle = class {
	constructor(hostRef) {
		...
		*/
		...
		this.onKeyDown = (ev) => {
			if (ev.key === " ") {
				ev.preventDefault();
				if (!this.disabled) this.toggleChecked();
			}
		};
		this.onClick = (ev) => {
			/**
		...
		*/
		...
		this.getSwitchLabelIcon = (mode, checked) => {
			if (mode === "md") return checked ? checkmarkOutline : removeOutline;
	...
	async connectedCallback() {
		...
		*/
		...
		this.itemFocusObserver = createItemMultipleInputsObserver(el, () => forceUpdate(this), ["item-multiple-inputs", "ion-activatable"]);
	}
	componentDidLoad() {
		this.setupGesture();
		this.didLoad = true;
	...
	renderToggleControl() {
		...
		}, enableOnOffLabels && mode === "ios" && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], h("div", { class: "toggle-icon-wrapper" }, h("div", {
			class: "toggle-inner",
			part: "handle"
	...
	*/
	renderHintText() {
		...
		return h("div", { class: "toggle-bottom" }, h("div", {
			id: helperTextId,
			class: "helper-text",
	...
	render() {
		...
		return h(Host, {
			key: "148d15040257b05b3769da5a2439d051e357cbba",
			role: "switch",
			...
			key: "0dbc40adc87e2ab4bdcd9a9fef43393484174c18",
			class: "toggle-wrapper",
			htmlFor: inputId
		}, h("input", {
			key: "92dee565687fc9a883f97091ead1bbb51df43779",
			type: "checkbox",
			role: "switch",
			"aria-checked": `${checked}`,
			checked,
			...
			key: "f057bc57714b26e84226ee931e09212b86dba69f",
			class: {
		...
		}, h("slot", { key: "345efb5ce20f8124d1e74877b4943edf82fe2f8e" }), this.renderHintText()), h("div", {
			key: "fc1a7fb6b65064307fbe0a50178559a52d6aedb7",
...
var shouldToggle = (rtl, checked, deltaX, margin) => {
	if (checked) return !rtl && margin > deltaX || rtl && -margin < deltaX;
	else return !rtl && -margin < deltaX || rtl && margin > deltaX;
};
var toggleIds = 0;
Toggle.style = {
	ios: toggleIosCss(),
