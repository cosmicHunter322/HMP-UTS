import { a as config, b as setMode, f as getMode, h as printIonWarning, o as configFromSession, s as configFromURL, y as saveConfig } from "./index-Dvqtt_WK-CtfmC4By.js";
//#region node_modules/@ionic/core/dist/esm/ionic-global-BSaFA7np.js
/*!
...
var initialize = (userConfig = {}) => {
	...
	if (config.getBoolean("persistConfig")) saveConfig(win, configObj);
	setupPlatforms(win);
	Ionic.config = config;
	...
	if (config.getBoolean("_testing")) config.set("animated", false);
	...
	setMode((elm) => {
		while (elm) {
			...
			if (elmMode) {
				...
				else if (isIonicElement(elm)) printIonWarning("Invalid ionic mode: \"" + elmMode + "\", expected: \"ios\" or \"md\"");
			}
...
//#endregion
export { isPlatform as i, getPlatforms as n, initialize as r, getIonMode as t };
